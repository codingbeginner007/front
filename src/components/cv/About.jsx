    ...
    return (<section className="resume-section" id="about">
        ...
        further the overall value proposition.</p>
            <div className="social-icons">
                <a className="social-icon" href=" https://linkedin.com"><i className="fab fa-linkedin-in" /></a>
                <a className="social-icon" href=" https://github.com/"><i className="fab fa-github" /></a>
                <a className="social-icon" href=" https://twitter.com/"><i className="fab fa-twitter" /></a>
                <a className="social-icon" href=" https://facebook.com"><i className="fab fa-facebook-f" /></a>
            </div>
        </div>
    </section>);
}
